...
internal class Program 
{
		static void Main(string[] args)  
        {
         ...
         Console.WriteLine("La membrecia A: ");
         Console.WriteLine("La membrecia B: ");
         Console.WriteLine("La membrecia C: ");
         Console.WriteLine("Si no cuenta con membrecia ingrese la palabra: no ");
